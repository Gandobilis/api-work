  ...
  <tr>
    ...
    <td class="px-6 py-4 resize">
      <div class="flex w-[100px]">
        <input v-if="editing" v-model="newName" class="outline-none border border-gray-300 rounded-lg p-1"/>
        <div class="flex justify-center space-x-2">
          <button
              :style="{'background-color': editing ? 'rgb(34 197 94)': 'rgb(59 130 246)'}"
